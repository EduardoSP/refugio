...
SECRET_KEY = '7l578bxk7q7%nn_lo^wa72yee2m7c9mumr7pua6m39-gd135#1'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],#configuracion del directorio de las templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#indica a que aplicacion nos va redireccionar despues de loguear
