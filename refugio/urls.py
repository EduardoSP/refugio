...
urlpatterns = [
    ...
    #url para mostrar el formulario de recuperacion de contrasenia
    ...
    #url cuando ya se ha hecho el envio del correo
    url(r'^reset/password_done', password_reset_done, {'template_name': 'registration/password_reset_done.html'}, 
        name='password_reset_done'),
    #url a la que nos va a llevar el link
    url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>.+)/$', password_reset_confirm, 
        {'template_name': 'registration/password_reset_confirm.html'},
        name='password_reset_confirm'),
    #url cuando ya se ha completado el reseteo de la contrasenia
